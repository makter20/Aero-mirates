...
public class OrderManager {
	...
	public String placeOrder(String userId, String scheduleId, String paymentMode,String amount,String cardHolderName , String cardNumber , String expirationDate) throws SQLException {
		...
		statement.execute("INSERT INTO Payment (paymentId, paymentMode, amount, cardHolderName, cardNumber, expirationDate, bookingId) VALUES ('"+newPaymentId+"','"+paymentMode+"','"+amount+"', '"+cardHolderName+"','"+cardNumber+"', '"+expirationDate+"','"+newBookingId+"')");
